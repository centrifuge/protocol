        ...
        for (uint256 i; i < poolsToMigrate.length; i++) {
            ...
            poolMigrationSpell.castPool(
                ...
                PoolParamsInput({
                    ...
                    asyncRequestManager: AsyncRequestManager(payable(_contractAddr("asyncRequestManager"))),
                    syncManager: SyncManager(_contractAddr("syncManager")),
                    freezeOnly: FreezeOnly(_contractAddr("freezeOnly")),
                    fullRestrictions: FullRestrictions(_contractAddr("fullRestrictions")),
                    freelyTransferable: FreelyTransferable(_contractAddr("freelyTransferable")),
                    redemptionRestrictions: RedemptionRestrictions(_contractAddr("redemptionRestrictions")),
