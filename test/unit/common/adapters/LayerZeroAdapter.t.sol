...
} from "../../../../src/common/interfaces/adapters/ILayerZeroAdapter.sol";
...
contract MockLayerZeroEndpoint is Mock {
    ...
    {
        values_uint256["params.dstEid"] = uint256(params.dstEid);
        ...
        values_bool_return["params.payInLzToken"] = params.payInLzToken;
...
contract LayerZeroAdapterTest is LayerZeroAdapterTestBase {
        ...
        public
    {
        ...
        assertEq(endpoint.values_uint256("params.dstEid"), uint256(LAYERZERO_ID));
        ...
        assertEq(endpoint.values_bool_return("params.payInLzToken"), false);
