...
contract DepositTest is BaseTest {
    ...
    function testPartialDepositExecutions() public {
        ...
        AsyncVault vault = AsyncVault(vault_);
        centrifugeChain.updateSharePrice(poolId, vault.trancheId(), 1000000000000000000, uint64(block.timestamp));
    ...
    function testDepositAndRedeemPrecisionWithSlippage(bytes16 scId) public {
        ...
        centrifugeChain.updateSharePrice(poolId, scId, 1010101010101010101, uint64(block.timestamp));
