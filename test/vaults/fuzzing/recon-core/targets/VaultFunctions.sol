...
abstract contract VaultFunctions is BaseTargetFunctions, Properties {
    ...
    function vault_requestDeposit(uint256 assets) public {
        ...
        uint256 balanceOfEscrowB4 = assetErc20.balanceOf(address(poolEscrowFactory.escrow(poolId)));
        ...
        uint256 balanceOfEscrowAfter = assetErc20.balanceOf(address(poolEscrowFactory.escrow(poolId)));
    ...
    function vault_requestRedeem(uint256 shares) public {
        ...
        uint256 balanceOfEscrowB4 = token.balanceOf(address(poolEscrowFactory.escrow(poolId)));
        ...
        uint256 balanceOfEscrowAfter = token.balanceOf(address(poolEscrowFactory.escrow(poolId)));
    ...
    function vault_deposit(uint256 assets) public {
        ...
        uint256 shareEscrowB4 = token.balanceOf(address(poolEscrowFactory.escrow(poolId)));
        ...
        uint256 shareEscrowAfter = token.balanceOf(address(poolEscrowFactory.escrow(poolId)));
    ...
    function vault_redeem(uint256 shares) public {
        ...
        uint256 tokenEscrowB4 = assetErc20.balanceOf(address(poolEscrowFactory.escrow(poolId)));
        ...
        uint256 tokenEscrowAfter = assetErc20.balanceOf(address(poolEscrowFactory.escrow(poolId)));
