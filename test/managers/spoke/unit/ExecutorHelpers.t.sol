...
import {IExecutorHelpers} from "../../../../src/managers/spoke/interfaces/IExecutorHelpers.sol";

import "forge-std/Test.sol";

// ─── Guards ──────────────────────────────────────────────────────────────────

contract ExecutorHelpersGuardTest is Test {
    ExecutorHelpers helpers;

    function setUp() public {
        helpers = new ExecutorHelpers();
    }
    ...
    function testRevertIfFalseReverts() public {
        vm.expectRevert(IExecutorHelpers.ConditionFalse.selector);
    ...
    function testRevertIfTrueReverts() public {
        vm.expectRevert(IExecutorHelpers.ConditionTrue.selector);
...
contract ExecutorHelpersMathTest is Test {
    ExecutorHelpers helpers;
...
contract ExecutorHelpersComparisonTest is Test {
    ExecutorHelpers helpers;
...
contract ExecutorHelpersBooleanTest is Test {
    ExecutorHelpers helpers;
...
contract ExecutorHelpersTernaryTest is Test {
    ExecutorHelpers helpers;
...
contract ExecutorHelpersContextTest is Test {
    ExecutorHelpers helpers;
...
contract ExecutorHelpersTupleTest is Test {
    ExecutorHelpers helpers;
...
contract ExecutorHelpersCastTest is Test {
    ExecutorHelpers helpers;
    ...
    function testToUint256FromIntNegativeReverts() public {
        vm.expectRevert(IExecutorHelpers.CastOverflow.selector);
