...
import {ActorManager} from "./helpers/ActorManager.sol";
...
abstract contract Setup is BaseSetup, SharedStorage, ActorManager {
    ...
    function setup() internal virtual override {
        // Setup actors, address(this) is the default actor so doesn't need to be added
    ...
    function setupFork() internal {
        ...
        _setDefaultActor(address(0x7829E5ca4286Df66e9F58160544097dB517a3B8c)); // adds + sets the gateway as the default
            // actor
