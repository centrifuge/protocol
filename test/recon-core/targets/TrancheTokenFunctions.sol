...
abstract contract TrancheTokenFunctions is BaseTargetFunctions, Properties {
    ...
    function trancheToken_approve(address spender, uint256 value) public useActor {
    ...
    function trancheToken_mint(address to, uint256 value) public notGovFuzzing useActor {
        require(_canDonate(to), "never donate to escrow");
