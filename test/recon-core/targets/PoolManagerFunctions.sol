...
abstract contract PoolManagerFunctions is BaseTargetFunctions, Properties {
    ...
    function poolManager_transferTrancheTokensToEVM(
        ...
        // Exact approval
        // NOTE: external calls below so need to prank directly here
        vm.prank(_getActor());
    ...
    // TODO: Overflow stuff
    function poolManager_handleTransferTrancheTokens(uint128 amount, uint256 toEntropy)
        public
        notGovFuzzing
        updateBeforeAfter
        useActor
    {
        ...
        poolManager.handleTransferTrancheTokens(poolId, trancheId, to, amount);
