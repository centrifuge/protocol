...
abstract contract ERC7540CentrifugeProperties is Setup, Asserts, ERC7540Properties {
    ...
    // NOTE: These pass an input parameter to allow the ERC7540Properties to be overridden, even though the paramters
    // are sometimes not used
    function erc7540_3(address erc7540Target) public override statelessTest {
        _centrifugeSpecificPreChecks();

        ERC7540Properties.erc7540_3(address(vault));
    }

    function erc7540_4(address erc7540Target) public override statelessTest {
        _centrifugeSpecificPreChecks();

        ERC7540Properties.erc7540_4(address(vault));
    }

    function erc7540_5(address erc7540Target) public override statelessTest {
        _centrifugeSpecificPreChecks();

        ERC7540Properties.erc7540_5(address(vault));
    }

    function erc7540_6_deposit(address erc7540Target, uint256 amt) public override statelessTest {
        _centrifugeSpecificPreChecks();

        ERC7540Properties.erc7540_6_deposit(address(vault), amt);
    }

    function erc7540_6_mint(address erc7540Target, uint256 amt) public override statelessTest {
        _centrifugeSpecificPreChecks();

        ERC7540Properties.erc7540_6_mint(address(vault), amt);
    }

    function erc7540_6_withdraw(address erc7540Target, uint256 amt) public override statelessTest {
        _centrifugeSpecificPreChecks();

        ERC7540Properties.erc7540_6_withdraw(address(vault), amt);
    }

    function erc7540_6_redeem(address erc7540Target, uint256 amt) public override statelessTest {
        _centrifugeSpecificPreChecks();

        ERC7540Properties.erc7540_6_redeem(address(vault), amt);
    }

    function erc7540_7(address erc7540Target, uint256 shares) public override statelessTest {
        _centrifugeSpecificPreChecks();

        ERC7540Properties.erc7540_7(address(vault), shares);
    }

    function erc7540_8(address erc7540Target) public override statelessTest {
        _centrifugeSpecificPreChecks();

        ERC7540Properties.erc7540_8(address(vault));
    }

    function erc7540_9_deposit(address erc7540Target) public override statelessTest {
        _centrifugeSpecificPreChecks();

        ERC7540Properties.erc7540_9_deposit(address(vault));
    }

    function erc7540_9_mint(address erc7540Target) public override statelessTest {
        _centrifugeSpecificPreChecks();

        ERC7540Properties.erc7540_9_mint(address(vault));
    }

    function erc7540_9_withdraw(address erc7540Target) public override statelessTest {
        _centrifugeSpecificPreChecks();

        ERC7540Properties.erc7540_9_withdraw(address(vault));
    }

    function erc7540_9_redeem(address erc7540Target) public override statelessTest {
        _centrifugeSpecificPreChecks();
