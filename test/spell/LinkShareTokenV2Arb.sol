...
/// @notice V2 Arbitrum-specific spell that transitions JTRSY share token to V3 control
/// @dev This spell runs on V2 Guardian/Root and grants v3 permissions on share tokens
contract LinkShareTokenV2Arb is LinkShareTokenV2Common {
    // Arbitrum V2 Root address
