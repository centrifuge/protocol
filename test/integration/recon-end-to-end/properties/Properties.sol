...
abstract contract Properties is BeforeAfter, Asserts, AsyncVaultCentrifugeProperties {
    ...
    function property_E_1() public tokenIsSet {
        ...
        uint256 balOfEscrow = MockERC20(address(vault.asset())).balanceOf(address(escrow)); // The balance of tokens in Escrow is sum of deposit requests plus transfers in minus transfers out
        unchecked {
