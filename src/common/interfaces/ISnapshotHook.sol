...
/// @notice Hook interface that is called whenever the accounting system of the Hub, for a given share token
///         1 network, aka a (poolId, scId, centrifugeId) tuple, is in a synchronous state. This means the assets
...
///         the snapshot hook reads state from the accounting latyer, the accounts of holdings and liabilities
