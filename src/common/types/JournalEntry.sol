...
library JournalEntryLib {
     ...
     */
    function toJournalEntries(bytes memory _bytes, uint256 _start, uint16 _length) pure returns (JournalEntry[] memory) {
...
using {encodePacked} for JournalEntry global;
