...
struct ShareClassDetails {
    ...
    mapping(AssetId assetId => IVaultManager) manager;
...
interface ISpoke {
    ...
    event InitializeVaultManager(
        PoolId indexed poolId, ShareClassId indexed scId, AssetId indexed assetId, IVaultManager manager
    );
