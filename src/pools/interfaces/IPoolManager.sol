...
interface IPoolManager {
    ...
    function notifyShareClass(uint32 chainId, PoolId poolId, ShareClassId scId, bytes32 hook) external;
    ...
    function allowPoolAdmin(PoolId poolId, address account, bool allow) external;
    ...
    function allowAsset(PoolId poolId, ShareClassId scId, AssetId assetId, bool allow) external;

    /// @notice Add a new share class to the pool
    function addShareClass(PoolId poolId, string calldata name, string calldata symbol, bytes calldata data) external;
    ...
    function approveRedeems(PoolId poolId, ShareClassId scId, AssetId payoutAssetId, D18 approvalRatio) external;
    ...
    function issueShares(PoolId poolId, ShareClassId id, AssetId depositAssetId, D18 navPerShare) external;
    ...
    function updateHolding(PoolId poolId, ShareClassId scId, AssetId assetId) external;

    /// @notice Updates the valuation used by a holding
    /// @param valuation Used to transform between payment assets and pool currency
    function updateHoldingValuation(PoolId poolId, ShareClassId scId, AssetId assetId, IERC7726 valuation) external;

    /// @notice Set an account of a holding
    function setHoldingAccountId(PoolId poolId, ShareClassId scId, AssetId assetId, AccountId accountId) external;
