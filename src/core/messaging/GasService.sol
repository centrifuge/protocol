...
contract GasService is IGasService {
    ...
    constructor(uint8[32] memory txLimits) {
        ...
        notifyPool = _gasValue(1355733); // create escrow case
        notifyShareClass = _gasValue(1933390);
        notifyPricePoolPerShare = _gasValue(147234);
        notifyPricePoolPerAsset = _gasValue(151047);
        notifyShareMetadata = _gasValue(160797);
        updateShareHook = _gasValue(136761);
        initiateTransferShares = _gasValue(307060);
        executeTransferShares = _gasValue(217870);
        updateRestriction = _gasValue(157670);
        trustedContractUpdate = _gasValue(168921);
        requestCallback = _gasValue(375279); // approve deposit case
        updateVaultDeployAndLink = _gasValue(2916252);
        updateVaultLink = _gasValue(227895);
